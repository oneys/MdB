...
const ProjectEditForm = ({ project, onClose, onUpdate }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <Label htmlFor="project-name-edit">Nom du projet</Label>
        <Input
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <Label htmlFor="dept-edit">Département</Label>
          <Select 
            value={formData.address.dept} 
            onValueChange={(value) => setFormData(prev => ({ 
              ...prev, 
        ...
        <div>
          <Label htmlFor="regime-edit">Régime TVA</Label>
          <Select 
            value={formData.regime_tva} 
            onValueChange={(value) => setFormData(prev => ({ ...prev, regime_tva: value }))}
          >
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <Label htmlFor="prix-achat-edit">Prix d'achat TTC</Label>
          <Input
            id="prix-achat-edit"
            type="number"
            value={formData.prix_achat_ttc}
        ...
        <div>
          <Label htmlFor="prix-vente-edit">Prix de vente TTC</Label>
          <Input
            id="prix-vente-edit"
            type="number"
            value={formData.prix_vente_ttc}
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <Label htmlFor="travaux-edit">Travaux TTC</Label>
          <Input
            id="travaux-edit"
            type="number"
        ...
        <div>
          <Label htmlFor="frais-agence-edit">Frais agence TTC</Label>
          <Input
            id="frais-agence-edit"
            type="number"
